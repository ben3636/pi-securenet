...
<link rel="stylesheet" href="alias-whitelist.css" media="screen">
  ...
  <body class="u-body u-grey-90"><header class="u-clearfix u-header u-header" id="sec-1ba6"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" id="carousel_7529" data-image-width="1600" data-image-height="1067">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-source-sans-pro u-text u-text-1">Whitelist Host</h2>
        <br>
        <br>
        <?php
  ...
  ?>
        ...
        <div class="u-form u-form-1">
          <form action="whitelist_submit.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true">
            <div class="u-form-group u-form-name">
              <label for="name-eded" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="Enter Entire Result Line" id="name-eded" name="entry" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
